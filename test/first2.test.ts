...
declare function describe(name:string, fn: Function): any;
declare function it(name:string, fn: Function): any;
declare function expect(assertion:any, message?: any): any;
...
const addToList = (val: Map<any,any>, list: LinkedMap<any, any>) => list.push(val, val.get('id'))
